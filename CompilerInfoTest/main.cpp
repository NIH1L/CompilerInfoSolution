...
int main() {
    ...
    const char* jsonInput = R"({"exePath": "C:\\Users\\91672\\Downloads\\HPDesignjetZ6100PhotoPrinterSeriesPS3.exe","rulesPath": "D:\\files\\codes\\C\\NIH1L\\CompilerInfoSolution\\rules.json"})";// 要检测的可执行文件路径
